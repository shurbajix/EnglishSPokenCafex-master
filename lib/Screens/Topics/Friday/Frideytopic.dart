...
class Frideytopic extends StatefulWidget {
    Frideytopic({Key? key, required this.initialUrl, required url,  required this.indextitle}) : super(key: key);
  final String initialUrl;
late  int indextitle;
  @override
  State<Frideytopic> createState() => _MondaytopicState();
}

class _MondaytopicState extends State<Frideytopic> {
